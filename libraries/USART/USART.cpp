...
/** USART_init  //FIXME add paudrate as a parameter!
 *
 ...
 *               16 * BAUD
 *
 * @param f_clk - master clock frequency usually 16000000L
 *
 * @param baud_rate #define baud_rate 19200L
 *
 * @return void
 */
void USART_init(unsigned long f_clk, unsigned long baud_rate, char terminator){
